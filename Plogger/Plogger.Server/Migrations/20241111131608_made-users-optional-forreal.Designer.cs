...
namespace Plogger.Server.Migrations
{
    ...
    [Migration("20241111131608_made-users-optional-forreal")]
    partial class madeusersoptionalforreal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Plogger.Server.Models.LoggerUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Plogger.Server.Models.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Plogger.Server.Models.LoggerUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Plogger.Server.Models.Entry", b =>
                {
                    ...
                    b.HasOne("Plogger.Server.Models.LoggerUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
